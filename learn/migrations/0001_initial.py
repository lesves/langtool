# Generated by Django 4.1.7 on 2023-02-26 21:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sentence', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='learn.sentence')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_progress', to='learn.task')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lang', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='courses', to='learn.language')),
                ('tasks', models.ManyToManyField(related_name='courses', to='learn.task')),
            ],
        ),
        migrations.AddField(
            model_name='user',
            name='languages',
            field=models.ManyToManyField(related_name='speakers', to='learn.language'),
        ),
        migrations.AddField(
            model_name='user',
